    ...
    <form action={formAction} className="space-y-6" encType="multipart/form-data" noValidate>
      ...
      <Field>
        ...
        <Input
          ...
          disabled={isPending}
        />
        {state.fieldErrors.title && <FieldError errors={[{ message: state.fieldErrors.title }]} />}
      </Field>
      ...
      <Field>
        ...
        <Input
          ...
          disabled={isPending}
        />
        {state.fieldErrors.price && <FieldError errors={[{ message: state.fieldErrors.price }]} />}
      </Field>
      ...
      <div className="grid grid-cols-2 gap-4 p-4 border border-gray-100 bg-gray-50 rounded-lg">
        <Field>
          ...
          <Input id="discountAmount" name="discountAmount" type="number" step="0.01" placeholder="0.00" disabled={isPending} />
        </Field>
        <Field>
      ...
      <Field>
        ...
        {state.fieldErrors.images && <FieldError errors={[{ message: state.fieldErrors.images }]} />}
      </Field>
